...
describe ZonesController, :type => :controller do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved zone as @zone" do
        ...
        allow_any_instance_of(Zone).to receive(:save).and_return(false)
        post :create, {:zone => { "name" => "invalid value" }}, valid_session
        expect(assigns(:zone)).to be_a_new(Zone)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested zone" do
        ...
        expect_any_instance_of(Zone).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => zone.to_param, :zone => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the zone as @zone" do
        zone = Zone.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Zone).to receive(:update).and_return(false)
        put :update, {:id => zone.to_param, :zone => { "name" => "invalid value" }}, valid_session
        expect(assigns(:zone)).to eq(zone)
      end
