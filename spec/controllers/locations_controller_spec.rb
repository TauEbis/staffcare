...
describe LocationsController, :type => :controller do
  ...
  let(:valid_attributes) { { "name" => "MyString", 'uid' => '87a75e22-e9c5-4dbc-875e-9523b0fdc78e', 'report_server_id' => 'my_string', 'zone_id' => zone.id, 'rooms' => 4, 'max_mds' => 2, 'speeds_attributes' => { '0' => { 'doctors' => 1, 'normal' => 4, 'max' => 6 } } } }
